...
const OurProductsContainer = () => {
  ...
  return (
    <div>
      {/* <div className=" bg-cover h-full w-full bg-center relative z-1 text-center py-[60px] md:py-[60px] lg:py-[170px] sm:py-[40px]"
                            ...
                            <input
                              ...
                              onChange={() => {
                                selectedCategory === category?._id
                                  ? setSelectedCategory('') // Unselect if double-click
                                  : setSelectedCategory(category?._id);
                                scrollToTopOnMobile(); // Scroll to top on mobile
                              }}
                              onDoubleClick={() => setSelectedCategory('')} // Handle double-click to unselect
                            />
